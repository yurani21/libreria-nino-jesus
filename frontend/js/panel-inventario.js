const categoriasMap = {
      ...
      data.forEach(libro => {
        ...
        const fila = `
          <tr>
            ...
            <td>$${precio}</td> <!-- Mostrar precio como entero -->
  ...
  async function guardarPublicacion() {
    ...
    const stock = document.getElementById("stock").value; // Usamos 'stock' en vez de 'Lib_Stock'
    ...
    formData.append("stock", stock); // Usamos 'stock' en vez de 'Lib_Stock'
